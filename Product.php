...
<aside class="col-md-4">
	...
	<div class="list-group">
		...
		<div class="col-md-3" style="padding: 0; margin:0; ">
			<img src="pic/b3.jpg" style="width:80px; height:100px;">
		</div>	
		<div class="col-md-9">
			<div class="list-group-item-heading">
				<h4>Drum set</h4>
...
<header class="col-md-8">
	...
	<div class="thumbnail">
		...
		<img src="pic/pic4.jpg" style="width: 100%;">
		<div class="caption">
		<h4 class="pull-right">NAVY VEHICLE</h4>
		<h5><a href="Product.php">PHP: 200,000,000</a></h5>
		<div><button class="btn btn-primary" data-target="#buyme" data-toggle="modal" style="margin-left: 10px; margin-bottom: 10px;">buy this vehicle</button></div>
		<div class="modal fade" id="buyme">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button class="close" data-dismiss="modal">&times;</button>
						<h2 class="modal-title">Buy vehicle</h2>
					</div>
